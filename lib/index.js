    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        legacyMode ? React.createElement(
          ...
          React.createElement('img', { style: imgPreviewStyle, ref: this.setRefFactory('img'), onLoad: onImageLoad })
        ) : React.createElement('video', { style: videoPreviewStyle, ref: this.setRefFactory('preview') }),
