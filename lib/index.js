  ...
  _createClass(Reader, [{
    ...
    value: function check() {
      ...
      if (legacyMode || preview && preview.readyState === preview.HAVE_ENOUGH_DATA) {
        ...
        this.worker.postMessage({ imageData: imageData });
      }
    }
  }, {
    ...
    value: function handleWorkerMessage(e) {
      var _props3 = this.props,
          handleScan = _props3.handleScan,
          legacyMode = _props3.legacyMode,
          handleImageNotRecognized = _props3.handleImageNotRecognized;
    ...
    value: function render() {
      ...
      return React.createElement(
        'section',
        null,
        this.props.legacyMode ? React.createElement(
          'div',
          null,
          React.createElement('input', { style: inputStyle, id: 'react-qr-reader-input', type: 'file', accept: 'image/*', ref: 'input', onChange: this.handleInputChange }),
          React.createElement('img', { style: _extends({}, previewStyle, { display: 'none' }), ref: 'img' })
        ) : React.createElement('video', { style: previewStyle, ref: 'preview' }),
        React.createElement('canvas', { style: canvasStyle, ref: 'canvas' })
      );
    }
  }]);
